...
package org.przybyl.ddj19.recordPatterns;
...
//            case Complex(Value(double r), Value(double i)) -> System.out.printf("I got the Complex [%f, %f]%n", r, i);
            case default -> System.out.printf("Was ist das? %s%n", s);
        }
...
//        }
    ...
    public static Object gimmeSomething() {
        return switch (random.nextInt(3)) {
            ...
            case 1 -> new Complex(new Value(random.nextDouble()), new Value(random.nextDouble()));
